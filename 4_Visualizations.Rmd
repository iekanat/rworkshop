...
You would use a histogram you are interested in frequencies of certain categories, like number of people with certain eye color.

```{r}
# Numbers we should see for verification. 
table(mtcars$gear)
