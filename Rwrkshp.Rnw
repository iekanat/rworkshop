...
All the documentation of this presentation has been prepared in R Studio. \vfill

Look into the Rmd documents to see how this was done. \vfill

summary function does not provide the best looking model summaries. Try the texreg package.\vfill
