...
Caret package is a wrapper for a host of classification and regression model training functions. It eases visualizations, data manipulation, and analytics among others. It currently supports over 150 types of models.\vfill 
...
## Let us create a simulated dataset to predict effect of age
# Create a dataset
...
208 observations and 61 variables\vfill
